...
public interface EntityMetricsProvider {
    ...
    /**
     * Method for calculating an entity's inverse document frequency. Formula
     * used to calculate IDF is
     *
     * @param entityId Freebase id of entity
     * @return a double representing the inverse document frequency of the entity,
     * as calculated above
     */
