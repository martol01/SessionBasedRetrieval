...
import com.ucl.search.sbr.services.entityDb.EntityMetricsProvider;
 ...
 */
public class CurrentRelevance implements EntityMetricsProvider {
        ...
        **/
        ...
        for(Entity e : entities){
            ...
            if(simpleMLEflag == false){
              //  probabilities.add(getEntityProbabilityDoc(getEntityCorpusCount(e.id), getEntityDocumentCount(e.id, docId), getDocumentLength(docId)));
            }
            else{
    ...
    public double getEntityProbabilityDoc(int entityOccurence, int docLen){
